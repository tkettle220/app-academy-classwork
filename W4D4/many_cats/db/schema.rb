...
ActiveRecord::Schema.define(version: 20170825000054) do
  ...
  create_table "logged_in_sessions", force: :cascade do |t|
    t.integer "user_id", null: false
    t.string "ip_address", null: false
    t.string "user_agent", null: false
    t.index ["user_id"], name: "index_logged_in_sessions_on_user_id"
  end
